...
# 4. Run the pipeline
cd src
python data_prep.py       # load data + feature engineering
python baseline.py        # compute baseline metrics
python train_model.py     # train the neural network
python evaluate.py        # generate plots and results
```
...
│   └── train.csv
├── src/
│   ├── data_prep.py         load + feature engineering
│   ├── baseline.py          baseline models
│   ├── train_model.py       NN training
