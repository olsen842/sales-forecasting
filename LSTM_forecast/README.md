...
**Feedforward model (this repo)**
```bash
git clone <sales-forecasting-repo-url>
cd sales-forecasting
pip install -r requirements.txt
# Download data from kaggle.com/competitions/store-sales-time-series-forecasting
...
**LSTM + dashboard (separate repo)**
```bash
git clone <lstm-sales-forecast-repo-url>
cd "LSTM sales forecast"
pip install -r requirements.txt
# Place train.csv, holidays_events.csv, oil.csv in store-sales-time-series-forecasting/
python LSTM.py        # train and save model
...
This project spans two repos — the feedforward model came first, the LSTM was built as a follow-up iteration.

**Repo 1 — sales-forecasting (feedforward)**
```
sales-forecasting/
├── README.md
├── requirements.txt
...
│   └── evaluate.py              Plots and final metrics
└── results/
    ├── predictions_vs_actual.png
    └── march_2017_zoom.png
```

**Repo 2 — LSTM sales forecast**
```
LSTM sales forecast/
