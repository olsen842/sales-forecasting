...
os.makedirs("mappe uden navn/save_model", exist_ok=True)
...
torch.save(model.state_dict(), "/Users/eliasolsen/Documents/programering/mappe uden navn/save_model/model.pt")
joblib.dump(x_scaler, "/Users/eliasolsen/Documents/programering/mappe uden navn/save_model/x_scaler.pkl")
joblib.dump(y_scaler, "/Users/eliasolsen/Documents/programering/mappe uden navn/save_model/y_scaler.pkl")
print("saved model and scalers to save_model/")

#baseline results:
#yesterday:     MAE=$151,830  RMSE=$188,420
#7-day avg:     MAE=$133,112  RMSE=$162,825

#best score from linaer neural network: MAE=$78,350  RMSE=$127,129
#best score from LSTM neural network: MAE=$75,294  RMSE=$108,563
#after some teewks with batch and ReduceLROnPlateau i went down to neural network: MAE=$70,439  RMSE=$103,746
#after adding eraly stopping neural network: MAE=$62,413  RMSE=$97,933
#change dropout to 0.15 and increased patience to 25: neural network: MAE=$63,418  RMSE=$97,801
#added an set seed and the score i got neural network: MAE=$59,859  RMSE=$94,944

#hvad der skal laves 
#“Reduce overstock by X%”
#“Predict demand to optimize inventory”
#“Avoid lost sales”
#lave API (fx Flask/FastAPI eller  batch prediction (CSV → predictions)
#hvad modellen gør
#hvorfor den virker
#hvad kunden får ud af det